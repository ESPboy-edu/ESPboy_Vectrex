...
static uint16_t reg_a;
static uint16_t reg_b;

/* direct page register */

static uint16_t reg_dp;

/* condition codes */

static uint16_t reg_cc;

/* flag to see if interrupts should be handled (sync/cwai). */

static uint16_t irq_status;

static uint16_t *rptr_xyus[4] = {
	&reg_x,
	&reg_y,
	&reg_u,
	&reg_s
...
static  void set_cc (uint16_t flag, uint16_t value)
{
	reg_cc &= ~flag;
	reg_cc |= value * flag;
}
...
static  uint16_t test_c (uint16_t i0, uint16_t i1,
...
static  uint16_t test_n (uint16_t r)
{
	return (r >> 7) & 1;
}
...
static  uint16_t test_z8 (uint16_t r)
{
	uint16_t flag;
...
static  uint16_t test_z16 (uint16_t r)
{
	uint16_t flag;
...
static  uint16_t test_v (uint16_t i0, uint16_t i1, uint16_t r)
{
	uint16_t flag;
...
static  uint16_t get_reg_d (void)
{
	return (reg_a << 8) | (reg_b & 0xff);
}

static  void set_reg_d (uint16_t value)
{
	reg_a = value >> 8;
	reg_b = value;
}
...
static  void push8 (uint16_t *sp, uint16_t data)
{
	(*sp)--;
	write8 (*sp, data);
}

static  uint16_t pull8 (uint16_t *sp)
{
	uint16_t data;
...
static  void push16 (uint16_t *sp, uint16_t data)
{
	push8 (sp, data);
	push8 (sp, data >> 8);
}

static  uint16_t pull16 (uint16_t *sp)
{
	uint16_t datahi, datalo;
...
static  uint16_t pc_read16 (void)
{
	uint16_t data;
...
static  uint16_t sign_extend (uint16_t data)
{
...
static  uint16_t ea_indexed (uint16_t *cycles)
{
	uint16_t r, op, ea;
 ...
 */
 ...
 uint16_t inst_neg (uint16_t data)
{
	uint16_t i0, i1, r;
...
/* instruction: com */
 ...
 uint16_t inst_com (uint16_t data)
{
	uint16_t r;
 ...
 */
 ...
 uint16_t inst_lsr (uint16_t data)
{
	uint16_t r;
 ...
 */
 ...
 uint16_t inst_ror (uint16_t data)
{
	uint16_t r, c;
 ...
 */
 ...
 uint16_t inst_asr (uint16_t data)
{
	uint16_t r;
 ...
 */
 ...
 uint16_t inst_asl (uint16_t data)
{
	uint16_t i0, i1, r;
 ...
 */
 ...
 uint16_t inst_rol (uint16_t data)
{
	uint16_t i0, i1, c, r;
 ...
 */
 ...
 uint16_t inst_dec (uint16_t data)
{
	uint16_t i0, i1, r;
 ...
 */
 ...
 uint16_t inst_inc (uint16_t data)
{
	uint16_t i0, i1, r;
...
/* instruction: suba/subb */
 ...
 uint16_t inst_sub8 (uint16_t data0, uint16_t data1)
{
	uint16_t i0, i1, r;
 ...
 */
 ...
 uint16_t inst_sbc (uint16_t data0, uint16_t data1)
{
	uint16_t i0, i1, c, r;
 ...
 */
 ...
 uint16_t inst_and (uint16_t data0, uint16_t data1)
{
	uint16_t r;
 ...
 */
 ...
 uint16_t inst_eor (uint16_t data0, uint16_t data1)
{
	uint16_t r;
 ...
 */
 ...
 uint16_t inst_adc (uint16_t data0, uint16_t data1)
{
	uint16_t i0, i1, c, r;
 ...
 */
 ...
 uint16_t inst_or (uint16_t data0, uint16_t data1)
{
	uint16_t r;
...
/* instruction: adda/addb */
 ...
 uint16_t inst_add8 (uint16_t data0, uint16_t data1)
{
	uint16_t i0, i1, r;
...
/* instruction: addd */
 ...
 uint16_t inst_add16 (uint16_t data0, uint16_t data1)
{
	uint16_t i0, i1, r;
...
/* instruction: subd */
 ...
 uint16_t inst_sub16 (uint16_t data0, uint16_t data1)
{
	uint16_t i0, i1, r;
...
/* instruction: 8-bit offset branch */
 ...
 void inst_bra8 (uint16_t test, uint16_t op, uint16_t *cycles)
{
...
/* instruction: 16-bit offset branch */
 ...
 void inst_bra16 (uint16_t test, uint16_t op, uint16_t *cycles)
{
	uint16_t offset, mask;
...
/* instruction: pshs/pshu */
 ...
 void inst_psh (uint16_t op, uint16_t *sp,
...
/* instruction: puls/pulu */
 ...
 void inst_pul (uint16_t op, uint16_t *sp, uint16_t *osp,
					   uint16_t *cycles)
{
	if (op & 0x01) {
		reg_cc = pull8 (sp);
 ...
 uint16_t exgtfr_read (uint16_t reg)
{
	uint16_t data;
 ...
 void exgtfr_write (uint16_t reg, uint16_t data)
{
	switch (reg) {
	case 0x0:
		set_reg_d (data);
